...
delete_category = '🗑️ delete caregory'
...
async def process_settings(message: Message):
    ...
    await message.answer('categories\' settings:', reply_markup=markup)
...
async def category_callback_handler(query: CallbackQuery, callback_data: dict, state: FSMContext):
    ...
    await query.answer('all items in this category.')
...
async def process_cancel(message: Message, state: FSMContext):
    ...
    await message.answer('sure, cancelled!', reply_markup=ReplyKeyboardRemove())
    await state.finish()
...
async def process_body(message: Message, state: FSMContext):
    ...
    await ProductState.next()
    await message.answer('photos?', reply_markup=back_markup())
...
async def process_image_url(message: Message, state: FSMContext):
    ...
    if message.text == back_message:
        ...
        await message.answer('you need to send photo of this product.')
...
async def process_price_invalid(message: Message, state: FSMContext):
    ...
    if message.text == back_message:
        ...
        async with state.proxy() as data:
            ...
            await message.answer("another photo?", reply_markup=back_markup())

    else:

        await message.answer('write down a price as a number!')
...
async def process_confirm_invalid(message: Message, state: FSMContext):
    await message.answer('there wasn\'t option like this.')
...
async def show_products(m, products, category_idx):
    ...
    await m.answer('wanna add or delete anything?', reply_markup=markup)
